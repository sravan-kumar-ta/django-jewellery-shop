...
class Category(models.Model):
    ...
    slug = models.CharField(max_length=60, verbose_name="Category Slug")
...
class Product(models.Model):
    ...
    product_image = models.ImageField(upload_to='products', blank=True, null=True, verbose_name="Product Image", default="products/default_image.img")
